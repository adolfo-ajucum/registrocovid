                ...
                <div class="row">
                        <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">
                             ...
                             <li class="nav-item">
                                <a class="nav-link" href="reporteconsulta.php" id="profile-tab" data-toggle="tab" href="reportegrafico.php" role="tab" aria-controls="profile" aria-selected="false">Consulta</a>
                            </li>
                        </ul>
